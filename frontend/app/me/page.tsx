...
import type { Json, Unit, Bill } from "@/models/types";
...
export default function MePage() {
  ...
  // /me ส่งบิลมาพร้อม payment (สลิปล่าสุด) แนบเพิ่มจากฟิลด์ของ Bill
  const [bills, setBills] = useState<(Json<Bill> & { payment?: any })[]>([]);
  const [err, setErr] = useState("");
  const [slipView, setSlipView] = useState<any>(null);
